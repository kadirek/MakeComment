...
import com.derikumas.makecomment.Models.User2;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            editor.putString("key_name_username", user.getDisplayName()); // Storing string
            editor.putString("key_name_email", user.getEmail()); // Storing string
            editor.putString("key_name_imageurl", user.getPhotoUrl().toString()); // Storing string
